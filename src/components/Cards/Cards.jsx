...
const CardSection = () => {
  return (
    <section className="flex items-center space-x-64 ">
      {/* Text Section */}
      <div className="w-[600px] flex flex-col items-center">
        <p className="text-gray-900 text-xl font-semibold mb-6">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
          Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. 
          Duis aute irure dolor in reprehenderit in qui officia deserunt mollit anim id est laborum.
        </p>
      ...
      <div className="relative">
        {/* Top Card */}
        <div className=" bg-cyan-900 w-[395px] h-[395px] rounded-xl text-white p-6 shadow-lg" style={{ zIndex: 3 }}>
        ...
        {/* Middle Card */}
        <div className="absolute bg-fuchsia-700 w-[355px] h-[355px] rounded-xl p-6 top-[20px] left-[60px] -z-20" ></div>

        {/* Bottom Card */}
        <div className="absolute bg-violet-950 w-[300px] h-[305px] rounded-xl p-6 top-[40px] left-[140px] -z-30" ></div>
      </div>
      </div>
